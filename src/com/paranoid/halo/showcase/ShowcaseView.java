...
import com.paranoid.halo.utils.AnimationUtils;
import com.paranoid.halo.utils.AnimationUtils.AnimationEndListener;
import com.paranoid.halo.utils.AnimationUtils.AnimationStartListener;
...
public class ShowcaseView extends RelativeLayout implements View.OnClickListener, View.OnTouchListener {
    ...
    public ShowcaseView(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray styled = context.getTheme().obtainStyledAttributes(attrs,
                R.styleable.ShowcaseView, R.attr.showcaseViewStyle, R.style.ShowcaseView);
        backColor = styled.getInt(R.styleable.ShowcaseView_sv_backgroundColor,
                Color.parseColor("#99000000"));
        detailTextColor = styled.getColor(R.styleable.ShowcaseView_sv_detailTextColor,
                Color.WHITE);
    ...
    private void init() {
        ...
        showcase = getResources().getDrawable(R.drawable.cling);
        ...
        if (!mOptions.noButton && mEndButton.getParent() == null) {
            ...
            if (!hasCustomText) {
                mEndButton.setText(getResources().getString(R.string.ok));
            }
        ...
        post(new Runnable() {
            ...
            public void run() {
                ...
                if (homeButton == null) {
                    ...
                    int homeId = activity.getResources().getIdentifier("abs__home", "id",
                ...
                if (homeButton == null) {
                    throw new RuntimeException("insertShowcaseViewWithType cannot be used when " +
                            "the theme has no ActionBar");
                }
     ...
     */
    public void overrideButtonText(CharSequence text) {
        if (mEndButton != null) {
    ...
    private float[] getBestTextPosition(int canvasW, int canvasH) {
        ...
        float spaceBottom = canvasH - voidedArea.bottom - 64 * metricScale;
        ...
        return new float[]{24 * metricScale, spaceTop > spaceBottom
